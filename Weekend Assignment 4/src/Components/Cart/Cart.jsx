...
const Cart = (props) => {
  ...
  return (
    <>
    <div>
    {props.cartItems.length === 0 && <span style={{color: "red"}}>THE CART IS EMPTY</span> } 
    </div>
  ...
  <button class="list-group-item flex-fill  text-black" onClick={() => props.addToCart(item['id'])}>+</button>
  <button class="list-group-item flex-fill  text-black" onClick={() => props.removeItems(item['id'])}>-</button>
